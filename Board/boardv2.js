(function (){
    ...
    */
    ...
    function checkTile(playerPos, player) {
    ...
    */
    ...
    function generalCollect(val, player){
        players[player].capital += val;
        console.log("Player's capital: "+ players[player].capital);
        console.log("Added "+val+" to player's account");
    }

    function collectKitty(player){
        var oldKitty = parkingKitty;
        if (parkingKitty > 0){
            players[player].capital += parkingKitty;
            parkingKitty = 0;
